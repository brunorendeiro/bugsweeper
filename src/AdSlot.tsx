 ...
 * substancial (ex. o painel de fim de jogo) — nunca no tabuleiro de jogo, que é
 * um ecrã interativo com pouco ou nenhum texto, para respeitar as políticas do
 * AdSense sobre anúncios em ecrãs sem conteúdo do publicador.
 */
